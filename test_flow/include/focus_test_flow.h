...
#ifndef TEST_WUKONG_FOCUS_TEST_H
#define TEST_WUKONG_FOCUS_TEST_H
...
public:
    FocusTestFlow(WuKongShellCommand &shellcommand);
    virtual ~FocusTestFlow();
...
#endif  // TEST_WUKONG_FOCUS_TEST_H
